...
import { RefreshCcw, CheckCircle2, Info, AlertCircle, FileText, Send, Loader2, Bot, User } from 'lucide-react';
...
export function ResponseChat({ data, onReset }: ResponseChatProps) {
